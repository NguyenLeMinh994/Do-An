<?php 
    ...
    {
        if(huySanPhamKhuyenMai($cuaHang,$_GET['idSP'])==true)
        {
             echo '<script type="text/javascript">alert("Hủy Sản Phẩm Thành Công");</script>';
        }
    }
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Danh Sách Sản Phẩm Khuyến Mãi</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        ...
                                        <?php
                                            ...
                                            $result=danhSachSanPhamKhuyenMai($cuaHang);
                                           ...
                                           <td> $ngayKetThuc</td>
                                                ...
                                                <td>
                                                    <a href='?idSP=$maSanPham' class='btn dark btn-outline uppercase'> 
