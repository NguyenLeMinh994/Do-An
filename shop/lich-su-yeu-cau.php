            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Lịch Sử Yêu Cầu</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                        ...
                                        <tbody>
                                            ...
                                            while ($r_yc=$yeucau->fetch_assoc()) 
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                    <?php 
                                                        if($r_yc['yc_trangthai']==1)
                                                        {
                                                            echo '<span class="badge badge-success badge-roundless">Chấp nhận</span>';
                                                        }
                                                        else
                                                            if($r_yc['yc_trangthai']==2)
                                                            {
                                                                echo '<span class="badge badge-danger badge-roundless">Từ chối</span>';
                                                            }
                                                            else
                                                            {
                                                                echo '<span class="badge badge-default badge-roundless">Chờ duyệt</span>';
                                                            }
                                                    ?>
