<?php 
    ...
    {
        if(huyKhuyenMai($cuaHang,$_GET['idKM'])==true)
        {
            echo '<script type="text/javascript">alert("Hủy Khuyến Mãi Thành Công");</script>';
        }
    }
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Danh Sách Khuyến Mãi</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        ...
                                        <tbody>
                                        <?php
                                            $result=danhSachKhuyenMai($cuaHang);

                                            if($result->num_rows > 0)
                                            {
                                                while ($row=$result->fetch_assoc()) 
                                                {
                                                    $tenKhuyenMai=$row['km_tieude'];
                                                    $phanTram=$row['km_hinhthuc_khuyenmai']."%";
                                                    $ngayBatDau=date("d-m-Y",strtotime($row['km_ngaybatdau']));
                                                    $ngayKetThuc=date("d-m-Y",strtotime($row['km_ngayketthuc']));
                                                    $maKhuyenMai=$row['km_ma'];
                                                    // $trangThai=$row['km_trangthai'];
                                           echo" <tr>
                                                <td> $tenKhuyenMai </td>
                                                <td> $phanTram </td>
                                                <td> $ngayBatDau </td>
                                                ...
                                                <td> 
                                                    <a href='chon-san-pham-khuyen-mai.php?idKM=$maKhuyenMai 'class='btn red btn-outline uppercase'> 
                                                        <i class='icon-basket-loaded'></i>
                                                    </a>
                                                    <a href='cap-nhat-khuyen-mai.php?idKM=$maKhuyenMai'  class='btn blue btn-outline uppercase'> 
                                                        <i class='icon-wrench'></i>
                                                    </a> 
                                                    <a href='?idKM=$maKhuyenMai' class='btn dark btn-outline uppercase'> 
