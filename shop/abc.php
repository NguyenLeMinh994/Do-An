                                                ...
                                                <form id="frmTaoKhuyenMai" class="form-horizontal form-bordered" method="post">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="alert alert-success display-hide">
                                                            <button class="close" data-close="alert"></button> Tạo khuyến mãi thành công! 
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="txtTenKhuyenMai" class="form-control" id="txtHoTen" value="">
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="form-group" >
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" name="txtPhanTram" class="form-control" placeholder="Số Phần Trăm" id="txtTuoi" value="">
                                                            </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-group input-large date-picker input-daterange" data-date="11/6/2017" data-date-format="dd/mm/yyyy">
                                                                    <input type="text" class="form-control" readonly name="txtFrom" value="">
                                                                    <span class="input-group-addon"> đến </span>
                                                                    <input type="text" class="form-control" readonly name="txtTo" value=""> </div>
                                                                    <!-- /input-group -->
                                                            </div>
                                                        </div>    
                                                    </div>
            ...
            $(window).load(function(e){
                ...
                success:function(data) {
                    ...
                    $.each(data,function(key,value){
                        // items.push('<li>'+key+' - '+ value.name +' '+ value.age + '</li>');
                        $('#txtHoTen').val(value.hoten);
                        $('#txtTuoi').val(value.tuoi);
                    });
                }
                });
            }); 
