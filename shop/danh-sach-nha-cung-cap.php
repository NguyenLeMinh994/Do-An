<?php 
    ...
    if(isset($_GET['idNCC']) && !empty($_GET['idNCC']))
    {
        huyNhaCungCap($_GET['idNCC']);  
    }
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Danh Sách Nhà Cung Cấp</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        ...
                                        <tbody>
                                        <?php
                                            $danhSachNhaCungCap=danhSachNhaCungCap($cuaHang);

                                            if($danhSachNhaCungCap->num_rows > 0)
                                            {
                                                while ($row=$danhSachNhaCungCap->fetch_assoc()) 
                                                {
                                                    $ma=$row['ncc_ma'];
                                                    $ten=$row['ncc_ten'];
                                                    $sdt=$row['ncc_sdt'];
                                                    $diachi=$row['ncc_diachi'];
                                                    $email=$row['ncc_email'];
                                           echo" <tr>
                                                <td> $ten </td>
                                                <td> $sdt </td>
                                                ...
                                                <td> 
                                                    <a href='cap-nhat-nha-cung-cap.php?idNCC=$ma' class='btn blue btn-outline uppercase'> 
                                                        <i class='icon-wrench'></i>
                                                    </a> 
                                                    <a href='?idNCC=$ma'class='btn dark btn-outline uppercase'> 
