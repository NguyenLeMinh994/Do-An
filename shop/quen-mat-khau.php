<?php 
    ...
    {   
        ...
        {
           $kq=quenMatKhau($username,$email,$newPassword);
           var_dump($kq);
           if($kq==true)
           {
               echo '<script type="text/javascript">alert("Đặt lại mật khẩu thành công");</script>';
        ...
        <div class="content">
            ...
            <form class="login-form" action="#" method="post">
                ...
                <div class="alert alert-danger display-hide"<?php echo $css; ?>>
                    ...
                    <span> Kiểm tra lại email, tên đăng nhâp và mật khẩu.</span>
                </div>
