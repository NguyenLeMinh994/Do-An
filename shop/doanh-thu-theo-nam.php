<?php  
    ...
    require_once "func_shop/func_thongke.php";
    if(isset($_POST['sltYears']))
    {
        $nam=$_POST['sltYears'];
    }
    else
...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Preview page of Metronic Admin Theme #4 for morris  ipsum" name="description" />
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Doanh Thu Theo Năm</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box green">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <form class="form-horizontal form-bordered" method="post" onsubmit="this.value">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <!-- id="touchspin_3" -->
                                                                <!-- <input type="text" name="txtSDT" class="form-control" placeholder="">  -->
                                                                <select name="sltYears" class="form-control" data-placeholder="Choose a Category" tabindex="1">
                                                    
                                                                   <?php  
                                                                        for ($Year=date("Y"); $Year>='2015'; $Year--) { 
                                                                            echo " <option value='$Year'".($Year==$nam?'selected':'').">$Year</option>";
                                                                        }
                                                                   ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="form-actions">
                                                            <div class="row">
                                                                <div class="col-md-offset-3 col-md-9">
                                                                    <button type="submit" class="btn green" name="btnXacNhan">Xác Nhận</button>
...
<![endif]-->
        ...
        <!-- <script src="../public/assets/pages/scripts/charts-morris.min.js" type="text/javascript"></script> -->
                ...
                new Morris.Bar({
                  ...
                  data: [
                    ...
                    <?php 
                        ...
                        $doanhthu=doanhThuCuaNam($cuaHang,$nam);
                        if($doanhthu->num_rows > 0)
                        {
                         while ($r_dt=$doanhthu->fetch_assoc()) {
                    ?>
                    { y:"Tháng <?php echo $r_dt['thang'] ?>", a:<?php echo $r_dt['sotien'] ?>  },
                   <?php 
                            } 
                        }
                        else
