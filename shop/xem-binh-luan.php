...
<head>
    ...
    <meta content="Preview page of Metronic Admin Theme #4 for bootstrap alerts, notes, tooltips, progress bars, labels, badges, paginations and more" name="description" />
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Xem Bình Luận</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
...
<script src="../public/assets/global/plugins/jquery-bootpag/jquery.bootpag.min.js" type="text/javascript"></script>
<script src="../public/assets/global/plugins/holder.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="../public/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="../public/assets/pages/scripts/ui-general.min.js" type="text/javascript"></script>
