<?php 
    ...
    if(isset($_POST['btnThem']))
    {
        ...
        {
            if(capNhatDanhSachHinh($_GET['idHinh'],$_GET['idSP'],$_FILES['file_hinh']))
            {
        ...
        if(!isset($_GET['idHinh']) && !isset($_GET['idSP']) && empty($_GET['idSP'])&& empty($_GET['idHinh']))
        {
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Cập nhật danh sách hình</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Hình Ảnh</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box green">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <!-- BEGIN  -->
                                                <?php  
                                                    $hinh=showHinh($_GET['idHinh']);
                                                    $r_hinh=$hinh->fetch_assoc();
                                                ?>
                                                <form  class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                                    <div class="form-body">
                                                        <div class="alert alert-danger display-hide" <?php echo $err ?>>
                                                            <button class="close" data-close="alert"></button> Cập nhật thất bại
                                                        </div>
                                                        <div class="alert alert-success display-hide" <?php echo $success ?>>Cập nhật thành công 
                                                            <button class="close" data-close="alert"></button> 
                                                        </div>
                                                        <div class="form-group ">
                                                            <label class="col-md-3 control-label">Tên Sản Phẩm</label>
                                                            <div class="col-md-4">
                                                                <span class="form-control-static"><?php echo $r_hinh['sp_ten']; ?></span>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                        <img src="..<?php echo $r_hinh['hinh_duongdanhinh']; ?>" alt="" /> </div>
                                                        ...
                                                        <div class="form-actions">
                                                            <div class="row">
                                                                <div class="col-md-offset-3 col-md-9">
                                                                    <button type="submit" class="btn green" name="btnThem">Thêm</button>
...
<![endif]-->
        ...
        <script src="../public/assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>
        <!--  -->
