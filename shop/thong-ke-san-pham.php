...
if(isset($_POST['btnXacNhan']))
{
    ...
    else
    {
        ...
        $sanpham=thongKeSanPhamBanRaTheoNgay($cuaHang,$ngaybatdau,$ngayketthuc);
    }
}
else
{
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Thông Kê Số Lượng</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                                            ...
                                                            <div class="form-actions">
                                                                <div class="row">
                                                                    <div class="col-md-offset-3 col-md-9">
                                                                        ...
                                                                        <button type="submit" class="btn default" id="idcleaner">Clean</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet box red">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-calendar-o"></i>Sản Phẩm</div>
                                            <div class="tools"> </div>
                                        </div>
