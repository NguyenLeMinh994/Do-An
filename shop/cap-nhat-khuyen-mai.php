<?php 
    ...
    if(isset($_POST["capNhatKhuyenMai"]))
    {
        $tenKhuyenMai=$_POST["txtTenKhuyenMai"];
        $phanTram=$_POST["txtPhanTram"];
        $ngayBatDau  =$_POST["txtFrom"];
        $ngayKetThuc =$_POST["txtTo"];

        if($tenKhuyenMai && $phanTram && $ngayBatDau &&$ngayKetThuc)
        {
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Cập Nhật Khuyến Mãi</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    <!-- BEGIN PAGE BASE CONTENT -->
                    <!-- Begin Tạo khuyến mãi -->
                                        ...
                                        <div class="portlet box green">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <?php 
                                                    ...
                                                    $ngayKT=date("d-m-Y",strtotime($row_KhuyenMai['km_ngayketthuc']));

                                                ?>

                                                <!-- id="frmTaoKhuyenMai" -->
                                                <form id="frmTaoKhuyenMai" class="form-horizontal form-bordered" method="post">
                                                    <div class="form-body">
                                                        <div class="alert alert-danger display-hide">
                                                            <button class="close" data-close="alert"></button> Kiểm tra lại các trường dữ liệu. 
                                                        </div>
                                                        <div class="alert alert-success display-hide">
                                                            <button class="close" data-close="alert"></button> Cập nhật khuyến mãi thành công! 
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="txtTenKhuyenMai" class="form-control" value="<?php echo $row_KhuyenMai['km_tieude']; ?>">
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="form-group" >
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" id="mask_number" name="txtPhanTram" class="form-control" placeholder="Số Phần Trăm" value=" <?php echo $row_KhuyenMai['km_hinhthuc_khuyenmai']; ?>">
                                                            </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-group input-large date-picker input-daterange" data-date="11/6/2017" data-date-format="dd-mm-yyyy">
                                                                    <input type="text" class="form-control" readonly name="txtFrom" value="<?php echo $ngayBD; ?>">
                                                                    <span class="input-group-addon"> đến </span>
                                                                    <input type="text" class="form-control" readonly name="txtTo" value="<?php echo $ngayKT; ?>"> </div>
                                                                    <!-- /input-group -->
                                                            </div>
                                                        </div>    
                                                    </div>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button type="submit" class="btn btn-circle green" name="capNhatKhuyenMai">Cập Nhật Khuyến Mãi</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
...
<![endif]-->
        ...
        <script src="../public/assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js" type="text/javascript"></script>
...
<!--         <script src="../public/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
 -->        <!-- END   Validate -->
        ...
        <!-- BEGIN INPUT MỚI -->
        <script src="../public/assets/global/plugins/jquery-inputmask/jquery.inputmask.bundle.min.js" type="text/javascript"></script>
        <script src="../public/assets/global/plugins/jquery.input-ip-address-control-1.0.min.js" type="text/javascript"></script>
        <!-- END INPUT MỚI -->
        <!-- END PAGE LEVEL PLUGINS -->
        ...
        <!-- BEGIN PAGE LEVEL SCRIPTS Mới-->
         <!-- BEGIN Validate -->
        <!-- 
        <script src="../public/assets/pages/scripts/form-validation.min.js" type="text/javascript"></script>
         -->
         <!-- Cách 2 -->
        ...
        <!-- BEGIN INPUT MỚI -->
        <script src="../public/assets/pages/scripts/form-input-mask.min.js" type="text/javascript"></script>
        <!-- END INPUT MỚI-->
