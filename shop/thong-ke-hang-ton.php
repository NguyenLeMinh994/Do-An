...
<head>
    <meta charset="utf-8" />
    <title>Cập Nhật Hàng Tồn Kho</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Cập Nhật Hàng Tồn Kho</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-calendar-o"></i>Cập Nhật Hàng Tồn</div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                                <?php  
                                                $hangton=danhSachHangTonKho($cuaHang);
                                                while($r_hanton=$hangton->fetch_assoc())
                                                {
                                                    $masp=$r_hanton['sp_ma'];
