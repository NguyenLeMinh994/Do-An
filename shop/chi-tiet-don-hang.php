                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <img alt="" class="img-circle" src="../public/assets/layouts/layout4/img/avatar9.jpg" /> </a>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN FORM-->
                    <?php  
                        $thongtinkhachhang=thongTinKhachHang($_GET['idHD']);
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <p class="form-control-static">
                                                                            <?php  
                                                                            if($r_khachhang['hd_trangthai']==1)
                                                                            {
                                                                                echo '<span class="label label-info"> Chưa Giao </span>';
                                                                            }
                                                                            else
                                                                                if($r_khachhang['hd_trangthai']==2)
                                                                                {
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    ...
                                                                    ?>
                                                                    <a href="?idHD=<?php echo $_GET['idHD'].'&idHoanThanh='.$_GET['idHD']; ?>" class="btn yellow">
                                                                            <i class="fa fa-pencil"></i> Xác Nhận
                                                                    </a>
                                                                    <?php 
                                                                        } 
