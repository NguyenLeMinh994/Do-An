<?php 
    ...
    if(isset($_POST["btnTaoKhuyenMai"]))
    {
        ...
        {
            $kq=taoKhuyenMai($tenKhuyenMai,$phanTram,$ngayBatDau,$ngayKetThuc,$cuaHang);
            if(!$kq==true)
            {
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Tạo Khuyến Mãi</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-group input-large date-picker input-daterange" data-date="11/6/2017" data-date-format="dd-mm-yyyy">
                                                                    <input type="text" class="form-control" readonly name="txtFrom" required>
