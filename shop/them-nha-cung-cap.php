<?php 
    ...
    {
        themNhaCungCap($cuaHang,$_POST['txtTenNCC'],$_POST['txtDiaChi'],$_POST['txtSDT'],$_POST['txtEmail']);
    }
 ?>
<!DOCTYPE html>
<!-- 
                                                ...
                                                <form id="frmNhaCungCap" class="form-horizontal form-bordered" method="post">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="col-md-4">
                                                            <input type="text" class="form-control" name="txtTenNCC" placeholder="Tên Nhà Cung Cấp">
                                                        </div>
                                                        </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="submit" class="btn green" name="btnThemNCC">Thêm Nhà Cung Cấp</button>
