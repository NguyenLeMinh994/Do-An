<?php 
     ...
     if(isset($maKhuyenMai) && isset($_GET['idSP']))
     {
        ...
        {
            echo '<script type="text/javascript">alert("Chọn sản phẩm khuyến mãi thành công");</script>';
        }
     }
    $tenKhuyenMai=layTenKhuyenMai($maKhuyenMai);
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="danh-sach-khuyen-mai.php">Danh Sách Khuyến Mãi</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span class="active">Chọn Sản Phẩm Khuyến Mãi</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                       ...
                                       Chọn Sản Phẩm Khuyến Mãi Cho |<?php echo $tenKhuyenMai; ?>|
                                    </div>
                                    <div class="actions">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                      ...
                                      <!--   <tfoot>
                                        ...
                                        echo"<tr>
                                                ...
                                                <td> $hangSanXuat </td>
                                                <td> 
                                                    <a href='?idKM=$maKhuyenMai&&idSP=$maSanPham'class='btn red btn-outline uppercase'> 
