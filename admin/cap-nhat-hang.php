            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Cập Nhật Hãng Sản Xuất</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!-- php:begin cập nhật hãng -->
                            <?php  
                                if(isset($_GET['idHang']))
                                {
                                    $hangTheoID = layHangTheoID($_GET['idHang']);
                                    $row_idhang = $hangTheoID->fetch_assoc();
                                    $tenhang=$row_idhang['hsx_ten'];
                                }
                            ?>
                            <!-- php:end -->
