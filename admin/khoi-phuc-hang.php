            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Khôi Phục Hãng</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php  
                                            $danhSachHang = danhSachHangBiHuy();
                                            while ($row_hang = $danhSachHang->fetch_assoc()) 
                                            {
                                                $tenhang=$row_hang['hsx_ten'];
                                                $mahang=$row_hang['hsx_ma'];

                                                ?>
                                                <tr>
                                                    <td><?php echo $tenhang; ?> </td>
                                                    <td> 
                                                        <a href='?idHang=<?php echo $mahang; ?>' class='btn dark btn-outline uppercase'> 
