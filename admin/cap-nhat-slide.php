<?php 
    ...
    if(isset($_POST['btnThemSlide']))
    {
        if(!empty($_FILES['file_hinh']['name']))
        {
           capNhatSlide($_GET['idSlide'],$_FILES['file_hinh']);
        }
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Cập nhật Slide</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                         <?php 
                                                                             $hinh=layHinhTheoId($_GET['idSlide']);
                                                                             $r_hinh=$hinh->fetch_assoc(); 
                                                                         ?>   
                                                                        <img src="..<?php echo $r_hinh['sl_duongdan']; ?>" alt="" /> </div>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="submit" class="btn btn-circle green" name="btnThemSlide">Cập nhật Slide</button>
