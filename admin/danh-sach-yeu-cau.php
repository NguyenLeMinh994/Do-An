...
require "func_admin/func_yeucau.php";
if(isset($_GET['idXN']) && !empty($_GET['idXN']))
{
    xacNhanYeuCau($_GET['idXN']);
}
else
    if(isset($_GET['idHuy']) && !empty($_GET['idHuy']))
    {
        tuChoiYeuCau($_GET['idHuy']);
    }
?>
<!DOCTYPE html>
<!-- 
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Quản Lý Yêu Cầu</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            while ($r_yc=$yeucau->fetch_assoc()) 
                                            {
                                                ?>
                                                <tr>
                                                    <td> <?php echo $r_yc['yc_ma']; ?></td>
                                                    <td> <?php echo $r_yc['ch_ten']; ?></td>
                                                    <td> <?php echo $r_yc['yc_tieude']; ?> </td>
                                                    <td> <?php echo $r_yc['yc_noidung']; ?> </td>
                                                    <td> <?php echo date("d/m/Y",strtotime($r_yc['yc_ngaydang'])); ?></td>
                                                    <td> 
                                                    <a href="?idXN=<?php echo $r_yc['yc_ma']; ?>" class="btn green btn-outline uppercase"> 
                                                        Xác Nhận
                                                    </a>
                                                    <a href="?idHuy=<?php echo $r_yc['yc_ma']; ?>" class="btn dark btn-outline uppercase"> 
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php  
                                            $yeucau=danhSachYeuCauDaXacNhan();
                                            while ($r_yc=$yeucau->fetch_assoc()) 
                                            {
                                                ?>
                                                <tr>
