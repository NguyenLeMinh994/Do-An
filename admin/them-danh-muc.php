<?php 
    ...
    if(isset($_POST['btnThemDanhMuc']))
    {
        ...
        {
            themDanhMuc($_POST['txtTenDanhMuc'],$_POST['txtGioiThieu'],$_FILES['file_hinh'],$_POST['txtDanhMuc']);
        }
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Thêm danh mục</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                                ...
                                                <form id="frmDanhMuc" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                           ...
                                                           <div class="col-md-4">
                                                            <input type="text" class="form-control" name="txtTenDanhMuc" placeholder="Tên danh mục">
                                                        </div>
                                                    </div>
                                                       ...
                                                       <div class="col-md-5">
                                                        <select id="select2-single-input-sm" class="form-control input-sm select2-multiple" name="txtDanhMuc">
                                                            <optgroup label="Chọn Loại Sản Phẩm">
                                                                ...
                                                                ?>
                                                                    <option value="<?php echo $r_dm['dm_ma']; ?>"><?php echo $r_dm['dm_ten']; ?></option>
                                                                <?php  
                                                                    }
                                                                ?>
                                                            </optgroup>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="submit" class="btn btn-circle green" name="btnThemDanhMuc">Thêm Danh Mục</button>
