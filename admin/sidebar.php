    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <li class="nav-item  ">
                ...
                <ul class="sub-menu"> 
                    <li class="nav-item  ">
                        <a href="danh-sach-cua-hang.php" class="nav-link ">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                   <li class="nav-item">
                    <a href="danh-sach-loai.php" class="nav-link ">
                        <i class="icon-bar-chart"></i>
                        <span class="title">Danh Sách Loại</span>
                        <span class="selected"></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="them-loai.php" class="nav-link ">
                        <i class="icon-bar-chart"></i>
                ...
                <li class="nav-item">
                    <a href="khoi-phuc-loai-sp.php" class="nav-link ">
                        <i class="icon-bar-chart"></i>
