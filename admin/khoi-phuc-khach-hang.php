<?php require "top.php"; 
    require "func_admin/func_khachang.php";
    if(isset($_GET['idKH']) && !empty($_GET['idKH']))
    {
        khoiPhucKhachHang($_GET['idKH']);
    }
?>
<!DOCTYPE html>
<!-- 
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #4 | Responsive Extension</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic Admin Theme #4 for responsive extension demos" name="description" />
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_2">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th class="all">Mã Khách Hàng</th>
                                                <th class="min-phone-l">Họ Tên</th>
                                        ...
                                        <tbody>
                                        <?php 
                                            $danhSachKhachHangBiHuy=danhSachKhachHangBiHuy();
                                            while ($row_kh=$danhSachKhachHangBiHuy->fetch_assoc())
                                            {
                                                $hotenkh=$row_kh['kh_hoten'];
                                                $makh=$row_kh['kh_ma'];
                                                $diachi=$row_kh['kh_diachi'];
                                                $sdt=$row_kh['kh_sdt'];
                                                $email=$row_kh['kh_email'];
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $sdt; ?></td>
                                                <td>
                                                    <a href='?idKH=<?php echo $makh; ?>' class='btn dark btn-outline uppercase'> 
