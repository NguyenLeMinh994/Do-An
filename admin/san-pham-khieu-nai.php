<?php require "top.php"; 
    ...
    if(isset($_GET['idXoa']) )
    {
        xoaSanPham($_GET['idXoa']);
    }
    else
        if(!isset($_GET['idCH']) || empty($_GET['idCH']))
        {
            header("Location:danh-sach-cua-hang.php");
        }
?>
<!DOCTYPE html>
<!-- 
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Sản Phẩm Khiếu Nại</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box dark">
                                <div class="portlet-title">
                                    <div class="caption ">
                                        <i class="fa fa-globe"></i>Sản Phẩm Khiếu Nại</div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_2">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th class="all">Mã Sản Phẩm</th>
                                                <th class="min-phone-l">Tên SP</th>
                                                <th class="min-tablet"> Số Lần</th>
                                        ...
                                        <tbody>
                                        <?php 
                                            $danhsachsp=sanphamkhieuNai($_GET['idCH']);
                                            while ($row_sp=$danhsachsp->fetch_assoc()) 
                                            {
                                        ?>
                                            <tr>
                                                <th></th>
                                                <td> <?php echo $row_sp['sp_ma']; ?> </td>
                                                <td> <?php echo $row_sp['sp_ten']; ?> </td>
                                                <td> <?php echo $row_sp['dem']; ?> </td>
                                                <td>
                                                    <a href="noi-dung-khieu-nai.php?idSP=<?php echo $row_sp['sp_ma']; ?>" class="btn dark btn-outline uppercase"> 
                                                        Xem
                                                    </a>
                                                    <?php  
                                                    if($row_sp['ch_canhbao']==1)
                                                    {

                                                    
                                                    ?>
                                                    <a href="?idXoa=<?php echo $row_sp['sp_ma'].'&idCH='.$_GET['idCH']; ?>" class="btn red btn-outline uppercase"> 
                                                      Xóa
                                                  </a>
                                                  <?php  
                                                    }
