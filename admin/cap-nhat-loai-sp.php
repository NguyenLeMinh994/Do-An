            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Cập Nhật Loại Sản Phẩm</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php 
                                ...
                                {
                                    $layLoaiTheoID=layLoaiTheoID($_GET['idLoaiSP']);
                                    $row_loai=$layLoaiTheoID->fetch_assoc();
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form id="frmLoai" class="form-horizontal form-bordered" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="txtTenLoai" class="form-control" placeholder="Tên Loại" value="<?php echo $tenloai; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="submit" name="btnCapNhatLoai" class="btn btn-circle green">Cập nhật loại</button>
                                                </div>
                                            </div>
                                        </div>
                                        </form>   
